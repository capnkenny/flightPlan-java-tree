/** 
   An interface for the ADT sorted list without duplicates.
   Entries in the list have positions that begin with 1.
   @author Frank M. Carrano
   @version 3.0
*/
public interface SortedListNoDuplicatesInterface<T extends Comparable<? super T>>
{
   /** Adds a new entry to this sorted list in its proper order.
       @param newEntry the object to be added as a new entry 
       @return true if newEntry was added to the list; otherwise
               returns false if newEntry is already in the list */
   ...
   public T[] toArray();
} // end SortedListNoDuplicatesInterface
